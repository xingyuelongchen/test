...
function fontColor() {
    ...
    var col = ['red', 'blue', 'yellow', 'green', 'black'];
    var textCol = ['红', '蓝', '黄', '绿', '黑'];
    var len = col.length; //固定的颜色长度
    var btnlen = eBtn.length;
    var random = randomNum(btnlen); //获取随机数
    ...
    eBtn[random].style.color = col[random]; //随机给按钮添加正确答案的颜色
